...
function App() {
  ...
  function handleSubmit(event)
  {
    ...
    const descriptors = Array.from(event.target.querySelectorAll('input[name="descriptors"]:checked'))
    ...
    <main>
      ...
      { displayPrompt ?
        <form onSubmit={handleSubmit}>
          ...
          <small className='descriptors-name'><u>Skills & Technologies</u></small>
          <div className='descriptors-container'>

            <div className='type-value'>
              <input type="checkbox" name="descriptors" value="Authentification" />
              Authentification
            </div>
